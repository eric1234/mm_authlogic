# Authlogic module that is mixed into all AR objects to allow the
# acts_as_authentic hook (and a few others) to be installed. We
# explicitly avoided loading this file from AuthLogic and are providing
# a new version that works with MongoMapper. Heavily based on the
# original at:
#
#   https://raw.github.com/binarylogic/authlogic/master/lib/authlogic/acts_as_authentic/base.rb
